...
libspdm_return_t spdm_responder_send_message_old(void *spdm_context,
...
libspdm_return_t spdm_responder_receive_message_old(void *spdm_context,
                                                size_t *message_size,
                                                void **message,
                                                uint64_t timeout)
{
